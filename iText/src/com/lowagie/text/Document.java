...
public class Document implements DocListener {
     ...
     * @since	2.1.6
     */
	private static final String PRODUCT = "iText";
    /**
     * This constant may only be changed by Paulo Soares and/or Bruno Lowagie.
     * @since	2.1.6
     */
	...
	/** This constant may only be changed by Paulo Soares and/or Bruno Lowagie. */
	public static String PRODUCER = PRODUCT + " " + RELEASE;
 ...
 */
    ...
    public boolean addCreationDate(java.util.Date date) {
        if (date==null) date = new Date();
        try {
            /* bugfix by 'taqua' (Thomas) */
            final SimpleDateFormat sdf = 
                new SimpleDateFormat("EEE MMM dd HH:mm:ss zzz yyyy");
            return add(new Meta(Element.CREATIONDATE, sdf.format(date)));
        } catch (DocumentException de) {
            throw new ExceptionConverter(de);
        }
    }
    ...
    public boolean addCreationDate() {
        return addCreationDate(new Date());
    }
