...
public class PdfContentByte {
    ...
    public void variableRectangle(Rectangle rect) {
        ...
        if (wb > 0) {
            ...
            moveTo(r, b); //r, b + wb / 2f
            lineTo(l, b); //l, b + wb / 2f
            stroke();
        }
        ...
        if (wr > 0) {
            ...
            moveTo(r, bt ? t : t - wt); //r - wr / 2f, bt ? t : t - wt
            lineTo(r, bb ? b : b + wb); //r - wr / 2f, bb ? b : b + wb
            stroke();
            if (!bt || !bb) {
                cdefi = true;
                if (cr == null)
        ...
        if (wl > 0) {
            ...
            moveTo(l, bt ? t : t - wt); //l + wl / 2f, bt ? t : t - wt
            lineTo(l, bb ? b : b + wb); //l + wl / 2f, bb ? b : b + wb
     ...
     * @param xScaleFactor the horizontal scaling. A value of 1.0 is no scaling.
     * @param b an element of the transformation matrix
     * @param c an element of the transformation matrix
     * @param yScaleFactor the vertical scaling. A value of 1.0 is no scaling.
     * @param x the x location of this template
     * @param y the y location of this template
     */
    public void addTemplate(PdfTemplate template, float xScaleFactor, float b, float c, float yScaleFactor, float x, float y) {
        checkWriter();
        ...
        content.append("q ");
        content.append(xScaleFactor).append(' ');
        content.append(b).append(' ');
        content.append(c).append(' ');
        content.append(yScaleFactor).append(' ');
        content.append(x).append(' ');
        content.append(y).append(" cm ");
