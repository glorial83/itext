    ...
    protected int goComposite(boolean simulate) throws DocumentException {
        ...
        while (true) {
            ...
            if (element.type() == Element.PARAGRAPH) {
                ...
                for (int keep = 0; keep < 2; ++keep) {
                    ...
                    if (compositeColumn == null) {
                      ...
                      //Bug Fix!
                        ...
                        alignment = (alignment==Element.ALIGN_UNDEFINED?this.alignment:alignment);
                        compositeColumn.setAlignment(alignment); //para.getAlignment()
              ...
              //Bug fix: The following "if" condition is commented out because
              //it is overriding values set in PdfPTable.setSpacingBefore()
