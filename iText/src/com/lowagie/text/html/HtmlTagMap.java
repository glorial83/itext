...
public class HtmlTagMap extends HashMap {
	...
	public HtmlTagMap() {
		...
		peer.addValue(ElementTags.STYLE, HtmlTags.CSS_VALUE_ITALIC);
		put(peer.getAlias(), peer);
		...
		peer.addValue(ElementTags.STYLE, HtmlTags.CSS_VALUE_BOLD);
		put(peer.getAlias(), peer);
		...
		peer.addValue(ElementTags.STYLE, HtmlTags.CSS_VALUE_LINETHROUGH);
		put(peer.getAlias(), peer);
		...
		peer.addValue(ElementTags.STYLE, HtmlTags.CSS_VALUE_UNDERLINE);
		put(peer.getAlias(), peer);
